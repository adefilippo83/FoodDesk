...
const en = {
  ...
  payMethodCounter: 'Counter',
  // cash / POS at the register (issue #63)
  payMethodCash: 'Cash',
  payMethodPos: 'Card (POS)',
  ...
  printCustomerQr: 'Print customer QR (PDF)',
  ...
  custPayAtPickup: 'Pay at the counter — the kitchen starts as soon as your order is paid.',
  ...
  custYourOrdersToday: 'Your orders today',
  onlinePaidLockedHint: 'Paid online — to change anything, cancel the whole order (it refunds automatically).',
  custOrderNotFound: 'Order not found — it may have expired.',
  custPeopleWord: 'people',
  custGoPay: 'Go to the counter and pay',
  custGoPayHint: 'Show this number at the counter to pay — then we start cooking.',
...
const it: typeof en = {
  ...
  prepaidBadge: 'prepagato',
  paymentInProgress: 'pagamento in corso',
  refundedBadge: 'rimborsato',
  refundedStat: 'Rimborsati',
  byPayment: 'Per metodo di pagamento',
  payMethodCounter: 'Cassa',
  ...
  printCustomerQr: 'Stampa QR clienti (PDF)',
  ...
  custPayAtPickup: 'Si paga alla cassa — la cucina parte appena l’ordine è pagato.',
  ...
  custYourOrdersToday: 'I tuoi ordini di oggi',
  onlinePaidLockedHint: 'Pagato online — per modificare qualcosa annulla tutto l’ordine (il rimborso è automatico).',
  custOrderNotFound: 'Ordine non trovato — potrebbe essere scaduto.',
  custPeopleWord: 'persone',
  custGoPay: 'Vai alla cassa a pagare',
  custGoPayHint: 'Mostra questo numero alla cassa per pagare — poi iniziamo a cucinare.',
...
const es: typeof en = {
  ...
  printCustomerQr: 'Imprimir QR clientes (PDF)',
  ...
  custPayAtPickup: 'Se paga en el mostrador — la cocina empieza en cuanto el pedido esté pagado.',
  ...
  custYourOrdersToday: 'Tus pedidos de hoy',
  onlinePaidLockedHint: 'Pagado online — para cambiar algo, anula todo el pedido (se reembolsa automáticamente).',
  custOrderNotFound: 'Pedido no encontrado — puede haber caducado.',
  custPeopleWord: 'personas',
  custGoPay: 'Ve al mostrador a pagar',
  custGoPayHint: 'Muestra este número en el mostrador para pagar — luego empezamos a cocinar.',
...
const fr: typeof en = {
  ...
  unpaidBadge: 'à payer',
  prepaidBadge: 'prépayée',
  paymentInProgress: 'paiement en cours',
  refundedBadge: 'remboursée',
  refundedStat: 'Remboursées',
  byPayment: 'Par moyen de paiement',
  payMethodCounter: 'Caisse',
  payMethodCash: 'Espèces',
  payMethodPos: 'Carte (TPE)',
  paymentLabel: 'Paiement',
  receivedLabel: 'Reçu',
  changeLabel: 'Monnaie',
  shortBy: 'Il manque',
  exactAmount: 'Exact',
  paidHow: 'Payé comment ?',
  ...
  printCustomerQr: 'Imprimer le QR clients (PDF)',
  ...
  custPayAtPickup: 'Paiement au comptoir — la cuisine démarre dès que la commande est payée.',
  ...
  custYourOrdersToday: 'Vos commandes du jour',
  onlinePaidLockedHint: 'Payée en ligne — pour modifier, annulez toute la commande (le remboursement est automatique).',
  custOrderNotFound: 'Commande introuvable — elle a peut-être expiré.',
  custPeopleWord: 'personnes',
  custGoPay: 'Passez payer au comptoir',
  custGoPayHint: 'Montrez ce numéro au comptoir pour payer — ensuite nous commençons à cuisiner.',
...
const pt: typeof en = {
  ...
  customerBadge: 'Cliente',
  unpaidBadge: 'por pagar',
  prepaidBadge: 'pré-pago',
  paymentInProgress: 'pagamento em curso',
  refundedBadge: 'reembolsado',
  refundedStat: 'Reembolsados',
  byPayment: 'Por método de pagamento',
  payMethodCounter: 'Caixa',
  payMethodCash: 'Dinheiro',
  payMethodPos: 'Cartão (POS)',
  paymentLabel: 'Pagamento',
  ...
  custPayAtPickup: 'Paga-se ao balcão — a cozinha começa assim que o pedido estiver pago.',
  ...
  custYourOrdersToday: 'Os teus pedidos de hoje',
  onlinePaidLockedHint: 'Pago online — para alterar algo, anula o pedido inteiro (o reembolso é automático).',
  custOrderNotFound: 'Pedido não encontrado — pode ter expirado.',
  custPeopleWord: 'pessoas',
  custGoPay: 'Vai ao balcão pagar',
  custGoPayHint: 'Mostra este número ao balcão para pagar — depois começamos a cozinhar.',
